...
void Initialize() {
    ...
    state.player->position = glm::vec3(-1.2,1.75,0);
    ...
    GLuint platformTextureID = LoadTexture("platformPack_tile047.png");
    ...
    state.platforms[4].position = glm::vec3(-4,-3.25f,0);
    ...
    GLuint platformTextureIDtwo = LoadTexture("platformPack_tile036.png");
    
    state.platforms[9].textureID = platformTextureIDtwo;
    state.platforms[9].position = glm::vec3(2,-3.25f,0);
    state.platforms[9].destination = true;
    
    state.platforms[10].textureID = platformTextureIDtwo;
    state.platforms[10].position = glm::vec3(3,-3.25f,0);
    state.platforms[10].destination = true;
    ...
    state.platforms[26].position = glm::vec3(-3,1.75f,0);
    
    state.platforms[27].textureID = platformTextureID;
    state.platforms[27].position = glm::vec3(3,0.5,0);
    
    state.platforms[28].textureID = platformTextureID;
    state.platforms[28].position = glm::vec3(1,0.5,0);
    
    state.platforms[29].textureID = platformTextureID;
    state.platforms[29].position = glm::vec3(2,0.5,0);
    ...
    state.landingPlatforms = new Entity[2];
...
void ProcessInput() {
    ...
    if (keys[SDL_SCANCODE_LEFT]) {
        state.player->acceleration.x -= 1.1;
    }
...
void Render() {
    ...
    if (state.player->win){
        DrawText(&program, fontTextureIDlol, "Mission Success!", 0.4, 0.005, glm::vec3(-3,0,0));
    }
    if(state.player->lost){
        DrawText(&program, fontTextureIDlol, "Mission Failed!!", 0.4, 0.005, glm::vec3(-3,0,0));
    }
